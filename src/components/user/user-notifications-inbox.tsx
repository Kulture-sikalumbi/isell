...
interface UserNotificationsInboxProps {
  notifications: UserNotification[];
}

export function UserNotificationsInbox({ notifications }: UserNotificationsInboxProps) {
  ...
  if (notifications.length === 0) {
    return (
      <div className="glass rounded-2xl p-12 text-center text-zinc-500">
        ...
        No notifications yet. You&apos;ll be notified when deposits are confirmed, activations are ready, or admin replies.
      </div>
    );
  }
