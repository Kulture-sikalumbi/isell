...
export default async function AdminSettingsPage() {
  ...
  return (
    <AdminShell title="Settings" description="Exchange rate, customer deposit accounts, and chat storage">
      <div className="max-w-2xl space-y-6">
        <ChatSettingsPanel />
        <section className="glass rounded-2xl p-6 border border-white/10">
          <h2 className="text-lg font-semibold text-white mb-2">Deposit & Exchange</h2>
          <h3 className="text-sm font-medium text-white mb-3 mt-6">Customer deposit accounts</h3>
        ...
        <section>
          <h3 className="text-sm font-medium text-white mb-3 mt-6">USD to ZMW exchange rate</h3>
